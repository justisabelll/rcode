                    ...
                    <TooltipTrigger
                      render={
                        <span
                          ...
                          className="inline-flex h-5 items-center rounded-full border border-border/80 bg-background/90 px-1.5 font-mono text-[10px] font-medium tracking-tight text-foreground shadow-xs"
                        />
                      }
                    >
                      {jumpLabel}
...
function SidebarBrand() {
  ...
  return (
    <Link
      ...
      className="sidebar-brand ml-[var(--workspace-titlebar-content-left)] h-7 w-fit min-w-0 shrink-0 items-center gap-1.5 overflow-hidden rounded-md px-1 text-foreground outline-hidden ring-ring focus-visible:ring-2"
      to="/"
    >
...
function SidebarThemeToggle() {
  ...
  const label =
    theme === "system"
      ? `Theme: System (${resolvedTheme}). Switch to light.`
      : theme === "light"
    ...
    <Tooltip>
      <TooltipTrigger
        render={
          <Button
            aria-label={label}
            className="ml-auto size-7 rounded-md text-muted-foreground/70 hover:text-foreground md:mr-1"
