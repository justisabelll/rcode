      ...
      >
        {visibleToastLayout.items.map(({ toast, visibleIndex, offsetY }) => {
          ...
          return (
            <Toast.Root
              className={cn(
                "absolute z-[calc(9999-var(--toast-index))] w-full overflow-visible select-none rounded-2xl border bg-popover text-popover-foreground shadow-lg/5 [transition:transform_.5s_cubic-bezier(.22,1,.36,1),opacity_.5s,height_.15s]",
          ...
          .map((toast) => {
            ...
            return (
              ...
              >
                <Toast.Root
                  className={cn(
                    "relative overflow-visible text-balance border bg-popover text-popover-foreground text-xs transition-[scale,opacity] data-ending-style:scale-98 data-starting-style:scale-98 data-ending-style:opacity-0 data-starting-style:opacity-0",
                    tooltipStyle ? "rounded-md shadow-md/5" : "rounded-2xl shadow-lg/5",
                  )}
